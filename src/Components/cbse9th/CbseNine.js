...
export default function CbseNine() {
        ...
        <>
            ...
            {/* <div className='cbseMainBtnGroup' >
                <div className='testBtnDiv'>
                    ...
                    <a href='/cbsenine'><div style={{ color: location.hash == '#ssc' ? 'white' : '#D00000', backgroundColor: location.hash == '#ssc' ? '#D00000' : 'white' }} className={`testBtn ${location.hash == '' ? 'testActive ' : 'nono'}`}>CBSE 9<sup>th</sup> STD</div></a>
                    <a href='/cbseten'><div style={{ color: location.hash == '#cbsc' ? 'white' : '#D00000', backgroundColor: location.hash == '#cbsc' ? '#D00000' : 'white' }} className='testBtn'>CBSE 10<sup>th</sup> STD</div></a>
                </div>
            </div> */}
            <div className='cbsenineTopDiv'>
                <div className='cbsenineMain'>
                    <div className='cbsenineLeftDiv'>
                        <img src={mainImg} />
                    </div>
                    <div className='cbsenineRightDiv'>
                        <h3>CBSE – 9<sup style={{textTransform:'lowercase'}}>th</sup> Std</h3>
                        <p>9th Std is when you start feeling the pressure. Most of your teachers will be rushing to complete the syllabus so you under pressure to give as many mock tests the next year as possible and be prepared for boards. Everyone around you will be discussing future plans and ambitions. At Nayak’s Tutorials, we help you understand the concepts and complete the syllabus and be fully ready for the future. Joining Nayak’s Tutorials in the 9th standard would be ideal as you will be in the top gear by the time you reach 10th and will be an inch closer to the rank you desire</p>
                    </div>
                </div>
            </div>

            <div className='cbsenineSecondDiv'>
                <div className='cbsenineSeconDiv'>
                    <h1>How Nayak’s Tutorials helps</h1>

                    <div className='cbsenineSeconMainDiv'>
                        <div className='cbsenineMultipleText'>
                            <div className='cbsenineMultipleInnerDiv'>
                                <img src={dot} />
            ...
            <div className='cbsenineThirdDiv'>
                <h1>Time management tips for 9<sup style={{ textTransform: 'lowercase' }}>th</sup> Standard CBSE students</h1>
                <div className='cbsenineMainDiv2'>
                    <div id='cbsenineFirst' className='cbsenineMultipleText2'>
                        <div className='cbsenineMultipleInnerDiv2'>
                            <img src={dot2} />
                    ...
                    <div className='cbsenineMultipleText2'>
                        <div className='cbsenineMultipleInnerDiv2'>
                            <img src={dot2} />
                    ...
                    <div id='matrixBoxx' className='cbsenineMultipleText2'>
                        <div className='cbsenineMultipleInnerDiv2'>
                            <img src={dot2} />
            ...
            <div className='cbsenineLastDiv'>
                <h3 className='cbsenineFaq'>FAQ's</h3>
                ...
                <Accordion allowMultipleExpanded={false} allowZeroExpanded>
                    <AccordionItem >
                        <AccordionItemHeading>
                            <AccordionItemButton>
                                What are the subjects for 9th grade in CBSE?
                            </AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel>

                            English, Hindi, Maths, Science, and Social Science.
                ...
                <Accordion allowMultipleExpanded={false} allowZeroExpanded>
                    <AccordionItem >
                        <AccordionItemHeading>
                            <AccordionItemButton>
                                Which is the toughest subject in 9th std CBSE?
                            </AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel>

                            Maths is often perceived as a challenging subject by many. However, if you understand the concepts well and practice enough, you can sail through easily.
                ...
                <Accordion allowMultipleExpanded={false} allowZeroExpanded>
                    <AccordionItem >
                        <AccordionItemHeading>
                            <AccordionItemButton>
                                What strategy can we use while preparing for CBSE Class 9?
                            </AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel>
            ...
            <div className='cbsenineTriviaImgDiv'>
                <img src={trivia} />
            </div>
            {/* <Footer /> */}
        </>
