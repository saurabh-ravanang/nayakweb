...
export default function IgcseTen() {
        ...
        <>
            ...
            {/* <div className='cbseMainBtnGroup'>
                <div className='testBtnDiv'>
                    ...
                    <a href='/igcsenine'><div style={{ color: location.hash == '/cbsenine' ? 'white' : '#D00000', backgroundColor: location.hash == '#icsc' ? '#D00000' : 'white' }} className='testBtn'>IGCSE 9<sup>th</sup> STD</div></a>
                    <a href='/igcseten'><div style={{ color: location.hash == '#ssc' ? 'white' : '#D00000', backgroundColor: location.hash == '#ssc' ? '#D00000' : 'white' }} className={`testBtn ${location.hash == '' ? 'testActive ' : 'nono'}`}>IGCSE 10<sup>th</sup> STD</div></a>
                </div>
            </div> */}
            ...
            <div className='icseeightTopDiv'>
                <div className='icseeightMain'>
                    ...
                    <div className='icseeightRightDiv'>
                        <h3>IGCSE – 10<sup style={{textTransform:'lowercase'}}>th</sup> Std</h3>
                        <p>IGCSE has a comprehensive syllabus and mostly tests each child’s creative thinking and problem-solving ability. Their syllabus is vast and requires students to put in extra effort on their own. It is here that Nayak’s Tutorials and our teachers help and guide each student to bring out their best and get better grades than earlier.
                            It’s never too late to join Nayak’s Tutorials. You can join us even in the 10th standard and benefit from the Nayak’s touch.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className='icseeightThirdDiv'>
                <h1>Time management tips for 10<sup style={{ textTransform: 'lowercase' }}>th</sup> Standard IGCSE students</h1>
                <div className='icseeightMainDiv2'>
                    ...
                    <div style={{visibility:"hidden"}} id='matrixBoxx2 ' className='hidebox icseeightMultipleText2'>
                        <div className='icseeightMultipleInnerDiv2'>
                            <img src={dot2} />
                            <h3>Use this matrix</h3>
                        </div>
            ...
            <div className='icseeightLastDiv'>
                ...
                <Accordion allowMultipleExpanded={false} allowZeroExpanded>
                    <AccordionItem >
                        <AccordionItemHeading>
                            <AccordionItemButton>
                                How can I prepare well for IGCSE board 10th standard?
                            </AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel>

                            Here are some preparation tips for IGCSE 10th standard.
                            Prepare a study plan
                            Complete the syllabus well ahead of time. Read the basic study material, follow it with a thorough study of additional reference books.
                            A month before examination
                            Keep all formulae and definitions in one place and revise them. See what needs a detailed study and also solve previous years’ papers.
                            A day before the examination
                            Keep your mind fresh and stress-free and focus on the paper. You can go through pointers, formulae and definitions.
                            Just before the examination
                            Stay relaxed as you have prepared well.
                            Examination time
                            Read the questions well. Add charts, diagrams, references and more.
                ...
                <Accordion allowMultipleExpanded={false} allowZeroExpanded>
                    <AccordionItem >
                        ...
                        <AccordionItemPanel>
                            ...
                            Most certainly. IGCSE is an accepted board and students can apply to IIT and other competitive exams in the country.
                        </AccordionItemPanel>
                    </AccordionItem>
                </Accordion>
                <Accordion allowMultipleExpanded={false} allowZeroExpanded>
