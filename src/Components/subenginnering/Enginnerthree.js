...
function Enginnerthree() {
    return (
        <>

            <Helmet>
                <meta charSet="utf-8" />
                <title>MHT-CET 2-Year Course for Class 11-12 (2025-27)</title>
                <meta name="title" content="MHT-CET 2-Year Course for Class 11-12 (2025-27)" />
                <meta name="description" content="Enroll in the MHT-CET ACE 40 Batch, a 2-year course for Class 11-12 students. Prepare for MHT-CET and board exams to get into top colleges in Maharashtra. Join now!" />
                <link rel="canonical" href="https://nayakstutorials.com/ace-40-batch-for-mht-cet-engineer/" />
                    ...
                    <div className='subengbluediv'>
                        ...
                        <div className='subengblueflex'>
                            ...
                            <div className='subengblue2'>
                                ...
                                {/* <li className='subli2'>Experienced & qualified faculty team</li>
                            <li className='subli2'>Regular Theory Classes (6 days a week).</li>
                            <li className='subli2'>Comprehensive Study Materials</li>
                            <li className='subli2'>Rigorous Practice & Testing (Weekly, Minor & Major)</li>
                            <li className='subli2'>Adaptive Assessment</li>
                            <li className='subli2'>Personalised Coaching & Care</li>
                            <li className='subli2'>Excellent Mentoring by Experts</li>
                            <li className='subli2'>Regular updates to parent and more. </li> */}
                        ...
                        <div className='subengblueflex'>
                            ...
                            <div className='subengblue2'><p>PCM / PCMB</p></div>
                        </div>
                        <div className='subengblueflex'>
